...
//   constructor(props){
  ...
  //     this.state = {
  //       recipe: recipe,
  //       url:`https://www.food2fork.com/api/get?key=db43fcbff2591ffbafb2d9ec735abe6a&rId=${this.props.id}`
  //     };
  //   }
    
  // async componentDidMount() {
  //   try{const data = await fetch(this.state.url);
  ...
  async componentDidMount(){
    ...
    const url = `https://www.food2fork.com/api/get?key=f7496f9ae4778172077936c8e4c022da&rId=${id}`;
    try{
         ...
         <div className="container">
           <div className="row">
             ...
             <div className="col-10 mx-auto col-md-6 my-3">
              ...
              <h6 className="text-warning text-capitalize text-heading">
              ...
              <ul className="list-group mt-4">
                <h2 className="mt-3 mb-4">Ingredients</h2>
                {
                  ingredients.map((item,index)=>{
                    return(
                      <li key={index} className="list-group-item text-heading">{item}</li>
                    )
                  })
                }
              </ul>
